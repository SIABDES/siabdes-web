...
import EditGeneralJournal from '@/components/add-edit-journal';
...
export default function EditJournal() {
  ...
  return (
    <Layout>
      <h1 className="text-2xl font-bold mb-4 text-center">Ubah Jurnal Umum</h1>
      <div className="container mb-4">
        ...
        <EditGeneralJournal nama_akuns={namaAkunsData} />
