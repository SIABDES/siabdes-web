...
export default function NotEmployee() {
  ...
  // menghitung pkp
  useEffect(() => {
    if (!grossSalaryWatcher) return;

    setValue('pkp_calculations.amount', grossSalaryWatcher);
    setValue('pkp_calculations.result', grossSalaryWatcher * 0.5);
  }, [grossSalaryWatcher, setValue]);
  ...
  const isLoading = useMemo(() => {
    return isAddPph21Loading || form.formState.isSubmitting;
  }, [form.formState.isSubmitting, isAddPph21Loading]);
        ...
        <Card className="bg-white border border-gray-300 p-3 rounded-xl mt-5 pb-5">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <div className="grid grid-cols-2 gap-x-9 mt-9 mb-9">
