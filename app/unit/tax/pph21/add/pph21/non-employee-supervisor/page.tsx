...
import PPh21Calculation from '@/components/pages/pph21/pph21/non-employee-supervisor/pph21-calculation';
import PPh21RateAYear from '@/components/pages/pph21/pph21/non-employee-supervisor/pph21-rate-a-year';
      ...
      <section>
        <header className="bg-[#B8E2F4] p-4">
          <h1 className="text-center font-bold text-xl">
            PPH 21 Lainnya - Pegawai Non Pengawas
          </h1>
        </header>
