...
import PPh21OtherActivityParticipantPPh21Calculation from "@/components/pages/pph21/pph21/activity-participant/pph21-calculation";
import PPh21OtherActivityParticipantResults from "@/components/pages/pph21/pph21/activity-participant/result";
import PPh21OtherActivityParticipantSalary from "@/components/pages/pph21/pph21/activity-participant/salary";
...
import useAddPph21OtherActivityParticipants from "@/hooks/pph21/useAddPph21OtherActivityParticipants";
...
import {
  PPh21OtherActivityParticipantFormData,
...
export default function ActivityParticipant() {
  ...
  const form = useForm<PPh21OtherActivityParticipantFormData>({
    resolver: zodResolver(PPh21OtherActivityParticipantSchema),
    defaultValues: {
      employee_id: "",
      period: {
  ...
  const { mutateAsync: mutatePph21, isPending: isMutatePph21Pending } =
    useAddPph21OtherActivityParticipants();

  const onSubmit = async (data: PPh21OtherActivityParticipantFormData) => {
    try {
      if (!selectedEmployee) {
        toast({
        ...
        <Card className="bg-white border border-gray-300 p-3 rounded-xl mt-5 pb-5">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              ...
              />
              <PPh21OtherActivityParticipantSalary form={form} />
              <PPh21OtherActivityParticipantPPh21Calculation form={form} />
              {/* <Results form={form} /> */}
              <PPh21OtherActivityParticipantResults
                form={form}
