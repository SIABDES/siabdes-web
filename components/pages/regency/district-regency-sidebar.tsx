...
interface DistrictRegencySidebarProps {
  isOpen: boolean;
  toggleSidebar?: () => void;
}
...
export function DistrictRegencySidebar(props: DistrictRegencySidebarProps) {
  ...
  if (session.user.role === 'KECAMATAN') {
    links = {
      '/financial-statement': '/regency/financial-statement',
    };
  } else if (session.user.role === 'KABUPATEN') {
    links = {
      '/financial-statement': '/district/financial-statement',
    };
  }
  ...
  return (
    ...
    >
      ...
      <TooltipProvider>
        ...
        >
          <BumdesSidebarItem
            href={links['/financial-statement']}
            icon={HomeIcon}
            label="Dashboard"
